...
public class RequestBelumBayarActivity extends AppCompatActivity {
    ...
    private class AsyncTaskList extends AsyncTask<String, Integer, Double> {
        ...
        public void postData() {
            ...
            String url = "http://ridhoperdana.net/servisin/htdocs/public/api/customer/request/unpaid/"+TOKEN;
...
//                    Log.d("HASIL", res.toString());
                    ...
                    httpclient = new DefaultHttpClient();
                    url = "http://ridhoperdana.net/servisin/htdocs/public/api/admin/customer/request/bayar/"+obj.getTransaksi_id();
                    httpGet = new HttpGet(url);
                    HttpResponse response = httpclient.execute(httpGet);
