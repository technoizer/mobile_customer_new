 ...
 */
public class RequestHistoryListAdaptor extends ArrayAdapter<Request> {
    private List<Request> items;
    private int layoutResourceId;
    private Context context;

    public RequestHistoryListAdaptor(Context context, int layoutResourceId, List<Request> items){
